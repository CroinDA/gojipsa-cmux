...
- `dist/GOJIPSA-2.0.4.dmg`: Homebrew cask 배포용 DMG
...
v2.0.4 값으로 로컬 cask를 생성하고 fetch/install/Gatekeeper 검증까지 시연하려면:
...
```ruby
version "2.0.4"
sha256 "c3ff18a70c06b6ca66a6141266dd57080a107796a50de96b5bac5fa8b135365f"
```
...
`source=Notarized Developer ID`가 아니면 `VERSION=2.0.4 SIGNING_MODE=xcode-auto ./scripts/release.sh`로 다시 만든 artifact만 GitHub Release와 Homebrew cask에 반영한다.
